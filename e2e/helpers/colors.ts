export const BRAND = {
  600: 'rgb(13, 148, 136)',   // bg-brand-600 / #0d9488
...
export const CATEGORY = {
  ...
  actuador: { bg: 'rgb(245, 243, 255)', icon: 'rgb(139, 92, 246)' },   // violet-50 / violet-500
  power:    { bg: 'rgb(240, 253, 244)', icon: 'rgb(34, 197, 94)' },    // green-50 / green-500
}
